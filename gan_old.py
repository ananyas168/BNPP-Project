...
import pandas as pd
df = pd.read_csv('/content/drive/MyDrive/BNPP_Project/tabgan/train.csv',header= None)
...
class GAN():
    ...
    def train(self, data, train_arguments):
        ...
        for epoch in range(epochs):    
            ...
            noise = tf.random.normal((self.batch_size, self.noise_dim), seed = epoch)
            ...
            if epoch % sample_interval == 0 or epoch == epochs-1:
                ...
                z = tf.random.normal((46, self.noise_dim ),seed =epoch)
                gen_data = self.generator(z)
                print('gen_data',gen_data.shape)
                print('generated_data')
                np.savetxt('/content/drive/MyDrive/BNPP_Project/tabgan/model/model/noise/noise_{}l.csv'.format(epoch),z,delimiter=',')
                np.savetxt('/content/drive/MyDrive/BNPP_Project/tabgan/model/model/gen/saved{}.csv'.format(epoch),gen_data, delimiter=',')
        print('gen_data',gen_data.shape)
        np.savetxt('/content/drive/MyDrive/BNPP_Project/tabgan/model/model/gen_model_final.csv',gen_data,delimiter=',')
        # model_checkpoint_base_name11 = 'model/model/' + cache_prefix + '_{}_model_final.h5'
...
gan_args = [32, 5e-4, 4, df.shape[1], 128]
train_args = ['', 10, 100]
